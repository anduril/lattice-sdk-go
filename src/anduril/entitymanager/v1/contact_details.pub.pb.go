...
const file_anduril_entitymanager_v1_contact_details_pub_proto_rawDesc = "" +
	"\n" +
	"2anduril/entitymanager/v1/contact_details.pub.proto\x12\x18anduril.entitymanager.v1\"3\n" +
	"\x0eContactDetails\x12!\n" +
	"\fphone_number\x18\x01 \x01(\tR\vphoneNumberB\x88\x02\n" +
	"\x1ccom.anduril.entitymanager.v1B\x16ContactDetailsPubProtoP\x01ZNgithub.com/anduril/lattice-sdk-go/src/anduril/entitymanager/v1;entitymanagerv1\xa2\x02\x03AEX\xaa\x02\x18Anduril.Entitymanager.V1\xca\x02\x18Anduril\\Entitymanager\\V1\xe2\x02$Anduril\\Entitymanager\\V1\\GPBMetadata\xea\x02\x1aAnduril::Entitymanager::V1b\x06proto3"
