...
var file_anduril_entitymanager_v1_health_status_pub_proto_rawDesc = []byte{
	...
	0x49, 0x4e, 0x47, 0x10, 0x03, 0x42, 0x82, 0x02, 0x0a, 0x1c, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x6e,
	...
	0x61, 0x74, 0x75, 0x73, 0x50, 0x75, 0x62, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x4a,
...
func file_anduril_entitymanager_v1_health_status_pub_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_anduril_entitymanager_v1_health_status_pub_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Alert); i {
			case 0:
				return &v.state
			case 1:
		...
		file_anduril_entitymanager_v1_health_status_pub_proto_msgTypes[4].Exporter = func(v any, i int) any {
