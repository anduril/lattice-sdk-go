...
var file_anduril_entitymanager_v1_payloads_pub_proto_rawDesc = []byte{
	...
	0x4e, 0x10, 0x06, 0x42, 0x88, 0x02, 0x0a, 0x1c, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x6e, 0x64, 0x75,
	0x72, 0x69, 0x6c, 0x2e, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65,
...
func file_anduril_entitymanager_v1_payloads_pub_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_anduril_entitymanager_v1_payloads_pub_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_anduril_entitymanager_v1_payloads_pub_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_anduril_entitymanager_v1_payloads_pub_proto_msgTypes[2].Exporter = func(v any, i int) any {
