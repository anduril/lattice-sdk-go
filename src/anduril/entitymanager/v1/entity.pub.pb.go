...
const file_anduril_entitymanager_v1_entity_pub_proto_rawDesc = "" +
	...
	"\asensors\x18\x14 \x01(\v2!.anduril.entitymanager.v1.SensorsR\asensors\x12>\n" +
