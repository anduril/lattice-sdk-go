...
var file_anduril_entitymanager_v1_supplies_pub_proto_rawDesc = []byte{
	...
	0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x43, 0x4f, 0x44, 0x45, 0x5f, 0x58, 0x10, 0x14, 0x42, 0x88, 0x02,
...
func file_anduril_entitymanager_v1_supplies_pub_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_anduril_entitymanager_v1_supplies_pub_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_anduril_entitymanager_v1_supplies_pub_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Munition); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_anduril_entitymanager_v1_supplies_pub_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Fuel); i {
			case 0:
				return &v.state
			case 1:
