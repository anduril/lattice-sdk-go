...
var file_anduril_entitymanager_v1_media_pub_proto_rawDesc = []byte{
	...
	0xfb, 0x01, 0x0a, 0x1c, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x6e, 0x64, 0x75, 0x72, 0x69, 0x6c, 0x2e,
...
func file_anduril_entitymanager_v1_media_pub_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_anduril_entitymanager_v1_media_pub_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Media); i {
			case 0:
				return &v.state
			case 1:
		...
		file_anduril_entitymanager_v1_media_pub_proto_msgTypes[1].Exporter = func(v any, i int) any {
