...
var file_anduril_entitymanager_v1_signal_pub_proto_rawDesc = []byte{
	...
	0x4f, 0x52, 0x10, 0x10, 0x42, 0x86, 0x02, 0x0a, 0x1c, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x6e, 0x64,
	0x75, 0x72, 0x69, 0x6c, 0x2e, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x6d, 0x61, 0x6e, 0x61, 0x67,
	...
	0x2f, 0x73, 0x72, 0x63, 0x2f, 0x61, 0x6e, 0x64, 0x75, 0x72, 0x69, 0x6c, 0x2f, 0x65, 0x6e, 0x74,
	0x69, 0x74, 0x79, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x2f, 0x76, 0x31, 0x3b, 0x65, 0x6e,
	0x74, 0x69, 0x74, 0x79, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x76, 0x31, 0xa2, 0x02, 0x03,
	0x41, 0x45, 0x58, 0xaa, 0x02, 0x18, 0x41, 0x6e, 0x64, 0x75, 0x72, 0x69, 0x6c, 0x2e, 0x45, 0x6e,
	0x74, 0x69, 0x74, 0x79, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x2e, 0x56, 0x31, 0xca, 0x02,
	0x18, 0x41, 0x6e, 0x64, 0x75, 0x72, 0x69, 0x6c, 0x5c, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x6d,
	0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x5c, 0x56, 0x31, 0xe2, 0x02, 0x24, 0x41, 0x6e, 0x64, 0x75,
	...
	0xea, 0x02, 0x1a, 0x41, 0x6e, 0x64, 0x75, 0x72, 0x69, 0x6c, 0x3a, 0x3a, 0x45, 0x6e, 0x74, 0x69,
	0x74, 0x79, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x3a, 0x3a, 0x56, 0x31, 0x62, 0x06, 0x70,
...
func file_anduril_entitymanager_v1_signal_pub_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_anduril_entitymanager_v1_signal_pub_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Signal); i {
			case 0:
				return &v.state
			case 1:
		...
		file_anduril_entitymanager_v1_signal_pub_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*EmitterNotation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_anduril_entitymanager_v1_signal_pub_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_anduril_entitymanager_v1_signal_pub_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_anduril_entitymanager_v1_signal_pub_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_anduril_entitymanager_v1_signal_pub_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*LineOfBearing); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_anduril_entitymanager_v1_signal_pub_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*AngleOfArrival); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_anduril_entitymanager_v1_signal_pub_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*Fixed); i {
			case 0:
				return &v.state
			case 1:
		...
		file_anduril_entitymanager_v1_signal_pub_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_anduril_entitymanager_v1_signal_pub_proto_msgTypes[9].Exporter = func(v any, i int) any {
			switch v := v.(*PulseRepetitionInterval); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_anduril_entitymanager_v1_signal_pub_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_anduril_entitymanager_v1_signal_pub_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_anduril_entitymanager_v1_signal_pub_proto_msgTypes[12].Exporter = func(v any, i int) any {
			switch v := v.(*ScanCharacteristics); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
