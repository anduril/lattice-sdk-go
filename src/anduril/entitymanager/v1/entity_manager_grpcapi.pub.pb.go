...
const file_anduril_entitymanager_v1_entity_manager_grpcapi_pub_proto_rawDesc = "" +
	"\n" +
	"9anduril/entitymanager/v1/entity_manager_grpcapi.pub.proto\x12\x18anduril.entitymanager.v1\x1a)anduril/entitymanager/v1/entity.pub.proto\x1a)anduril/entitymanager/v1/filter.pub.proto\x1a-anduril/entitymanager/v1/rate_limit.pub.proto\x1a(anduril/entitymanager/v1/types.pub.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"P\n" +
	...
	"\theartbeat\x18\x02 \x01(\v2#.anduril.entitymanager.v1.HeartbeatR\theartbeat\"\xbb\x01\n" +
	"\vEntityEvent\x12B\n" +
	"\n" +
	...
	"\x06entity\x18\x03 \x01(\v2 .anduril.entitymanager.v1.EntityR\x06entity\"E\n" +
	"\tHeartbeat\x128\n" +
	...
	"\x16StreamEntityComponents\x127.anduril.entitymanager.v1.StreamEntityComponentsRequest\x1a8.anduril.entitymanager.v1.StreamEntityComponentsResponse0\x01B\x8e\x02\n" +
	"\x1ccom.anduril.entitymanager.v1B\x1cEntityManagerGrpcapiPubProtoP\x01ZNgithub.com/anduril/lattice-sdk-go/src/anduril/entitymanager/v1;entitymanagerv1\xa2\x02\x03AEX\xaa\x02\x18Anduril.Entitymanager.V1\xca\x02\x18Anduril\\Entitymanager\\V1\xe2\x02$Anduril\\Entitymanager\\V1\\GPBMetadata\xea\x02\x1aAnduril::Entitymanager::V1b\x06proto3"

var (
	file_anduril_entitymanager_v1_entity_manager_grpcapi_pub_proto_rawDescOnce sync.Once
	file_anduril_entitymanager_v1_entity_manager_grpcapi_pub_proto_rawDescData []byte
)
...
func file_anduril_entitymanager_v1_entity_manager_grpcapi_pub_proto_rawDescGZIP() []byte {
	file_anduril_entitymanager_v1_entity_manager_grpcapi_pub_proto_rawDescOnce.Do(func() {
		file_anduril_entitymanager_v1_entity_manager_grpcapi_pub_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_anduril_entitymanager_v1_entity_manager_grpcapi_pub_proto_rawDesc), len(file_anduril_entitymanager_v1_entity_manager_grpcapi_pub_proto_rawDesc)))
	})
...
func file_anduril_entitymanager_v1_entity_manager_grpcapi_pub_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_anduril_entitymanager_v1_entity_manager_grpcapi_pub_proto_rawDesc), len(file_anduril_entitymanager_v1_entity_manager_grpcapi_pub_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   1,
