...
const file_anduril_entitymanager_v1_filter_dynamic_pub_proto_rawDesc = "" +
	"\n" +
	"1anduril/entitymanager/v1/filter_dynamic.pub.proto\x12\x18anduril.entitymanager.v1\x1a)anduril/entitymanager/v1/filter.pub.proto\"\xe2\x01\n" +
	"\x10DynamicStatement\x12;\n" +
	"\x06filter\x18\x01 \x01(\v2#.anduril.entitymanager.v1.StatementR\x06filter\x12?\n" +
	"\bselector\x18\x02 \x01(\v2#.anduril.entitymanager.v1.StatementR\bselector\x12P\n" +
	"\n" +
	"comparator\x18\x03 \x01(\v20.anduril.entitymanager.v1.IntersectionComparatorR\n" +
	"comparator\"\x81\x01\n" +
	"\x16IntersectionComparator\x12Y\n" +
	"\x11within_comparison\x18\x01 \x01(\v2*.anduril.entitymanager.v1.WithinComparisonH\x00R\x10withinComparisonB\f\n" +
	"\n" +
	"comparison\"\x12\n" +
	"\x10WithinComparisonB\x87\x02\n" +
	"\x1ccom.anduril.entitymanager.v1B\x15FilterDynamicPubProtoP\x01ZNgithub.com/anduril/lattice-sdk-go/src/anduril/entitymanager/v1;entitymanagerv1\xa2\x02\x03AEX\xaa\x02\x18Anduril.Entitymanager.V1\xca\x02\x18Anduril\\Entitymanager\\V1\xe2\x02$Anduril\\Entitymanager\\V1\\GPBMetadata\xea\x02\x1aAnduril::Entitymanager::V1b\x06proto3"

var (
	file_anduril_entitymanager_v1_filter_dynamic_pub_proto_rawDescOnce sync.Once
	file_anduril_entitymanager_v1_filter_dynamic_pub_proto_rawDescData []byte
)
...
func file_anduril_entitymanager_v1_filter_dynamic_pub_proto_rawDescGZIP() []byte {
	file_anduril_entitymanager_v1_filter_dynamic_pub_proto_rawDescOnce.Do(func() {
		file_anduril_entitymanager_v1_filter_dynamic_pub_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_anduril_entitymanager_v1_filter_dynamic_pub_proto_rawDesc), len(file_anduril_entitymanager_v1_filter_dynamic_pub_proto_rawDesc)))
	})
...
func file_anduril_entitymanager_v1_filter_dynamic_pub_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_anduril_entitymanager_v1_filter_dynamic_pub_proto_rawDesc), len(file_anduril_entitymanager_v1_filter_dynamic_pub_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
