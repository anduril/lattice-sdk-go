...
func (m *IntersectionComparator) GetComparison() isIntersectionComparator_Comparison {
	if m != nil {
		return m.Comparison
	}
	return nil
...
func (x *IntersectionComparator) GetWithinComparison() *WithinComparison {
	if x, ok := x.GetComparison().(*IntersectionComparator_WithinComparison); ok {
...
var file_anduril_entitymanager_v1_filter_dynamic_pub_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x73, 0x6f, 0x6e, 0x42, 0x8d, 0x02, 0x0a, 0x1c, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x6e,
...
func file_anduril_entitymanager_v1_filter_dynamic_pub_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_anduril_entitymanager_v1_filter_dynamic_pub_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*DynamicStatement); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_anduril_entitymanager_v1_filter_dynamic_pub_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*IntersectionComparator); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_anduril_entitymanager_v1_filter_dynamic_pub_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*WithinComparison); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
