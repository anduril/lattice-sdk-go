...
type MeanKeplerianElements struct {
	...
	// Types that are assignable to Line2Field8:
	//
...
func (m *MeanKeplerianElements) GetLine2Field8() isMeanKeplerianElements_Line2Field8 {
	if m != nil {
		return m.Line2Field8
	}
	return nil
}

func (x *MeanKeplerianElements) GetSemiMajorAxisKm() float64 {
	if x, ok := x.GetLine2Field8().(*MeanKeplerianElements_SemiMajorAxisKm); ok {
...
func (x *MeanKeplerianElements) GetMeanMotion() float64 {
	if x, ok := x.GetLine2Field8().(*MeanKeplerianElements_MeanMotion); ok {
		return x.MeanMotion
	}
	return 0
}
...
type TleParameters struct {
	...
	//
	// Types that are assignable to Line1Field11:
	//
	//	*TleParameters_Bstar
	//	*TleParameters_Bterm
	...
	// Types that are assignable to Line1Field10:
	//
...
func (m *TleParameters) GetLine1Field11() isTleParameters_Line1Field11 {
	if m != nil {
		return m.Line1Field11
	}
	return nil
}

func (x *TleParameters) GetBstar() float64 {
	if x, ok := x.GetLine1Field11().(*TleParameters_Bstar); ok {
		return x.Bstar
	}
	return 0
}
...
func (x *TleParameters) GetBterm() float64 {
	if x, ok := x.GetLine1Field11().(*TleParameters_Bterm); ok {
		return x.Bterm
	}
	return 0
}
...
func (m *TleParameters) GetLine1Field10() isTleParameters_Line1Field10 {
	if m != nil {
		return m.Line1Field10
	}
	return nil
}

func (x *TleParameters) GetMeanMotionDdot() float64 {
	if x, ok := x.GetLine1Field10().(*TleParameters_MeanMotionDdot); ok {
...
func (x *TleParameters) GetAgom() float64 {
	if x, ok := x.GetLine1Field10().(*TleParameters_Agom); ok {
		return x.Agom
	}
	return 0
}
...
var file_anduril_type_orbit_pub_proto_rawDesc = []byte{
	...
	0x4d, 0x45, 0x10, 0x01, 0x42, 0xa2, 0x01, 0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x6e, 0x64,
	0x75, 0x72, 0x69, 0x6c, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x42, 0x0d, 0x4f, 0x72, 0x62, 0x69, 0x74,
	0x50, 0x75, 0x62, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68,
	...
	0x64, 0x75, 0x72, 0x69, 0x6c, 0x2f, 0x74, 0x79, 0x70, 0x65, 0xa2, 0x02, 0x03, 0x41, 0x54, 0x58,
	...
	0x72, 0x69, 0x6c, 0x3a, 0x3a, 0x54, 0x79, 0x70, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}

var (
	file_anduril_type_orbit_pub_proto_rawDescOnce sync.Once
	file_anduril_type_orbit_pub_proto_rawDescData = file_anduril_type_orbit_pub_proto_rawDesc
)

func file_anduril_type_orbit_pub_proto_rawDescGZIP() []byte {
	file_anduril_type_orbit_pub_proto_rawDescOnce.Do(func() {
		file_anduril_type_orbit_pub_proto_rawDescData = protoimpl.X.CompressGZIP(file_anduril_type_orbit_pub_proto_rawDescData)
	})
...
func file_anduril_type_orbit_pub_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_anduril_type_orbit_pub_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*OrbitMeanElements); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_anduril_type_orbit_pub_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*OrbitMeanElementsMetadata); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_anduril_type_orbit_pub_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*MeanKeplerianElements); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_anduril_type_orbit_pub_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*TleParameters); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_anduril_type_orbit_pub_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_anduril_type_orbit_pub_proto_rawDesc = nil
