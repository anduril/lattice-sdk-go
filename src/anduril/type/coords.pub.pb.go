...
const file_anduril_type_coords_pub_proto_rawDesc = "" +
	...
	"\x03mzz\x18\x06 \x01(\x01R\x03mzz\"=\n" +
	"\x05TMat2\x12\x10\n" +
	"\x03mxx\x18\x01 \x01(\x01R\x03mxx\x12\x10\n" +
	"\x03mxy\x18\x02 \x01(\x01R\x03mxy\x12\x10\n" +
	...
	"\vtranslation\x18\x04 \x01(\v2\x12.anduril.type.Vec3R\vtranslationB\xa7\x01\n" +
	"\x10com.anduril.typeB\x0eCoordsPubProtoP\x01Z2github.com/anduril/lattice-sdk-go/src/anduril/type\xa2\x02\x03ATX\xaa\x02\fAnduril.Type\xca\x02\fAnduril\\Type\xe2\x02\x18Anduril\\Type\\GPBMetadata\xea\x02\rAnduril::Typeb\x06proto3"
