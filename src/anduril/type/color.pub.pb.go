...
var file_anduril_type_color_pub_proto_rawDesc = []byte{
	...
	0x6c, 0x70, 0x68, 0x61, 0x42, 0xac, 0x01, 0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x6e, 0x64,
	0x75, 0x72, 0x69, 0x6c, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x42, 0x0d, 0x43, 0x6f, 0x6c, 0x6f, 0x72,
	0x50, 0x75, 0x62, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x38, 0x67, 0x69, 0x74, 0x68,
...
func file_anduril_type_color_pub_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_anduril_type_color_pub_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Color); i {
			case 0:
				return &v.state
			case 1:
