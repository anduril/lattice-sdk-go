...
var file_anduril_taskmanager_v1_generic_spec_pub_proto_rawDesc = []byte{
...
var (
	...
	file_anduril_taskmanager_v1_generic_spec_pub_proto_rawDescData = file_anduril_taskmanager_v1_generic_spec_pub_proto_rawDesc
)
...
func file_anduril_taskmanager_v1_generic_spec_pub_proto_rawDescGZIP() []byte {
	file_anduril_taskmanager_v1_generic_spec_pub_proto_rawDescOnce.Do(func() {
		file_anduril_taskmanager_v1_generic_spec_pub_proto_rawDescData = protoimpl.X.CompressGZIP(file_anduril_taskmanager_v1_generic_spec_pub_proto_rawDescData)
	})
...
func file_anduril_taskmanager_v1_generic_spec_pub_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_anduril_taskmanager_v1_generic_spec_pub_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_anduril_taskmanager_v1_generic_spec_pub_proto_rawDesc = nil
