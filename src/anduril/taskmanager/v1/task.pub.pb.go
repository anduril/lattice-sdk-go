...
var file_anduril_taskmanager_v1_task_pub_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x52, 0x0a, 0x61, 0x6c, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x5c,
	0x0a, 0x09, 0x54, 0x61, 0x73, 0x6b, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x35, 0x0a, 0x04, 0x63,
	0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x21, 0x2e, 0x61, 0x6e, 0x64, 0x75,
	...
	0x02, 0x42, 0xf6, 0x01, 0x0a, 0x1a, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x6e, 0x64, 0x75, 0x72, 0x69,
	0x6c, 0x2e, 0x74, 0x61, 0x73, 0x6b, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x2e, 0x76, 0x31,
	0x42, 0x0c, 0x54, 0x61, 0x73, 0x6b, 0x50, 0x75, 0x62, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01,
	0x5a, 0x50, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x64, 0x6f, 0x67,
	...
	0x76, 0x31, 0xa2, 0x02, 0x03, 0x41, 0x54, 0x58, 0xaa, 0x02, 0x16, 0x41, 0x6e, 0x64, 0x75, 0x72,
...
var file_anduril_taskmanager_v1_task_pub_proto_depIdxs = []int32{
	...
	8,  // 20: anduril.taskmanager.v1.Principal.system:type_name -> anduril.taskmanager.v1.System
	9,  // 21: anduril.taskmanager.v1.Principal.user:type_name -> anduril.taskmanager.v1.User
	18, // 22: anduril.taskmanager.v1.Principal.team:type_name -> anduril.taskmanager.v1.Team
	7,  // 23: anduril.taskmanager.v1.Principal.on_behalf_of:type_name -> anduril.taskmanager.v1.Principal
	7,  // 24: anduril.taskmanager.v1.Relations.assignee:type_name -> anduril.taskmanager.v1.Principal
	2,  // 25: anduril.taskmanager.v1.TaskEvent.event_type:type_name -> anduril.taskmanager.v1.EventType
	4,  // 26: anduril.taskmanager.v1.TaskEvent.task:type_name -> anduril.taskmanager.v1.Task
	3,  // 27: anduril.taskmanager.v1.TaskEvent.task_view:type_name -> anduril.taskmanager.v1.TaskView
	22, // 28: anduril.taskmanager.v1.TaskEvent.time:type_name -> google.protobuf.Timestamp
	12, // 29: anduril.taskmanager.v1.StatusUpdate.version:type_name -> anduril.taskmanager.v1.TaskVersion
	5,  // 30: anduril.taskmanager.v1.StatusUpdate.status:type_name -> anduril.taskmanager.v1.TaskStatus
	7,  // 31: anduril.taskmanager.v1.StatusUpdate.author:type_name -> anduril.taskmanager.v1.Principal
	22, // 32: anduril.taskmanager.v1.StatusUpdate.scheduled_time:type_name -> google.protobuf.Timestamp
	4,  // 33: anduril.taskmanager.v1.DefinitionUpdate.task:type_name -> anduril.taskmanager.v1.Task
	22, // 34: anduril.taskmanager.v1.Replication.stale_time:type_name -> google.protobuf.Timestamp
	19, // 35: anduril.taskmanager.v1.Allocation.active_agents:type_name -> anduril.taskmanager.v1.Agent
	19, // 36: anduril.taskmanager.v1.Team.members:type_name -> anduril.taskmanager.v1.Agent
	23, // 37: anduril.taskmanager.v1.TaskEntity.entity:type_name -> anduril.entitymanager.v1.Entity
...
func file_anduril_taskmanager_v1_task_pub_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_anduril_taskmanager_v1_task_pub_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Task); i {
			case 0:
				return &v.state
			case 1:
		...
		file_anduril_taskmanager_v1_task_pub_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_anduril_taskmanager_v1_task_pub_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_anduril_taskmanager_v1_task_pub_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_anduril_taskmanager_v1_task_pub_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*System); i {
			case 0:
				return &v.state
			case 1:
		...
		file_anduril_taskmanager_v1_task_pub_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
		...
		file_anduril_taskmanager_v1_task_pub_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_anduril_taskmanager_v1_task_pub_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_anduril_taskmanager_v1_task_pub_proto_msgTypes[8].Exporter = func(v any, i int) any {
			switch v := v.(*TaskVersion); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_anduril_taskmanager_v1_task_pub_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_anduril_taskmanager_v1_task_pub_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_anduril_taskmanager_v1_task_pub_proto_msgTypes[11].Exporter = func(v any, i int) any {
			switch v := v.(*Owner); i {
			case 0:
				return &v.state
			case 1:
		...
		file_anduril_taskmanager_v1_task_pub_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_anduril_taskmanager_v1_task_pub_proto_msgTypes[13].Exporter = func(v any, i int) any {
		...
		file_anduril_taskmanager_v1_task_pub_proto_msgTypes[14].Exporter = func(v any, i int) any {
			switch v := v.(*Team); i {
			case 0:
				return &v.state
			case 1:
		...
		file_anduril_taskmanager_v1_task_pub_proto_msgTypes[15].Exporter = func(v any, i int) any {
			switch v := v.(*Agent); i {
			case 0:
				return &v.state
			case 1:
		...
		file_anduril_taskmanager_v1_task_pub_proto_msgTypes[16].Exporter = func(v any, i int) any {
