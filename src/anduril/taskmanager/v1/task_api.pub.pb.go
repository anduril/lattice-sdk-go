...
var file_anduril_taskmanager_v1_task_api_pub_proto_rawDesc = []byte{
	...
	0x6b, 0x49, 0x64, 0x42, 0xef, 0x01, 0x0a, 0x1a, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x6e, 0x64, 0x75,
...
var (
	...
	file_anduril_taskmanager_v1_task_api_pub_proto_rawDescData = file_anduril_taskmanager_v1_task_api_pub_proto_rawDesc
)
...
func file_anduril_taskmanager_v1_task_api_pub_proto_rawDescGZIP() []byte {
	file_anduril_taskmanager_v1_task_api_pub_proto_rawDescOnce.Do(func() {
		file_anduril_taskmanager_v1_task_api_pub_proto_rawDescData = protoimpl.X.CompressGZIP(file_anduril_taskmanager_v1_task_api_pub_proto_rawDescData)
	})
...
func file_anduril_taskmanager_v1_task_api_pub_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_anduril_taskmanager_v1_task_api_pub_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_anduril_taskmanager_v1_task_api_pub_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_anduril_taskmanager_v1_task_api_pub_proto_msgTypes[2].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_anduril_taskmanager_v1_task_api_pub_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_anduril_taskmanager_v1_task_api_pub_proto_rawDesc = nil
