...
type StrikeReleaseConstraint struct {
	...
	// Types that are assignable to StrikeReleaseConstraint:
	//
...
func (m *StrikeReleaseConstraint) GetStrikeReleaseConstraint() isStrikeReleaseConstraint_StrikeReleaseConstraint {
	if m != nil {
		return m.StrikeReleaseConstraint
	}
	return nil
}

func (x *StrikeReleaseConstraint) GetReleaseArea() *v2.AreaConstraints {
	if x, ok := x.GetStrikeReleaseConstraint().(*StrikeReleaseConstraint_ReleaseArea); ok {
...
type ReleasePayload struct {
	...
	// Types that are assignable to ReleaseMethod:
	//
...
func (m *ReleasePayload) GetReleaseMethod() isReleasePayload_ReleaseMethod {
	if m != nil {
...
func (x *ReleasePayload) GetPrecisionRelease() *emptypb.Empty {
	if x, ok := x.GetReleaseMethod().(*ReleasePayload_PrecisionRelease); ok {
...
var file_anduril_tasks_v2_shared_strike_pub_proto_rawDesc = []byte{
	...
	0x61, 0x73, 0x65, 0x5f, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x42, 0xd5, 0x01, 0x0a, 0x14, 0x63,
	...
	0x72, 0x63, 0x2f, 0x61, 0x6e, 0x64, 0x75, 0x72, 0x69, 0x6c, 0x2f, 0x74, 0x61, 0x73, 0x6b, 0x73,
	0x2f, 0x76, 0x32, 0x2f, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x3b, 0x74, 0x61, 0x73, 0x6b, 0x73,
...
func file_anduril_tasks_v2_shared_strike_pub_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_anduril_tasks_v2_shared_strike_pub_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Smack); i {
			case 0:
				return &v.state
			case 1:
		...
		file_anduril_tasks_v2_shared_strike_pub_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Strike); i {
			case 0:
				return &v.state
			case 1:
		...
		file_anduril_tasks_v2_shared_strike_pub_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*StrikeReleaseConstraint); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_anduril_tasks_v2_shared_strike_pub_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*StrikeParameters); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_anduril_tasks_v2_shared_strike_pub_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*PayloadConfiguration); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_anduril_tasks_v2_shared_strike_pub_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*ReleasePayload); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
