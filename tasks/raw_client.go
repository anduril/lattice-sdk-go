...
func (r *RawClient) CreateTask(
...
) (*core.Response[*latticesdkgo.Task], error) {
	...
	return &core.Response[*latticesdkgo.Task]{
...
func (r *RawClient) QueryTasks(
	...
	opts ...option.RequestOption,
) (*core.Response[*latticesdkgo.TaskQueryResults], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	return &core.Response[*latticesdkgo.TaskQueryResults]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
...
func (r *RawClient) ListenAsAgent(
	...
	opts ...option.RequestOption,
) (*core.Response[*latticesdkgo.AgentRequest], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	return &core.Response[*latticesdkgo.AgentRequest]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
