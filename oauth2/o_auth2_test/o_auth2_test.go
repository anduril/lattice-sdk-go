...
func TestOAuth2GetTokenWithWireMock(
	t *testing.T,
) {
	wiremockPort := os.Getenv("WIREMOCK_PORT")
	if wiremockPort == "" {
	...
	_, invocationErr := client.OAuth2.GetToken(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestOAuth2GetTokenWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestOAuth2GetTokenWithWireMock", "POST", "/api/v1/oauth/token", nil, 1)
}
