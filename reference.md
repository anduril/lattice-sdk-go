...
**deliveryConstraints:** `*Lattice.DeliveryConstraints` — Describes scheduling constraints for Lattice when delivering the task to the agent.
...
**executionConstraints:** `*Lattice.ExecutionConstraints` — Describes scheduling constraints for the agent executing the task after it has been delivered.
