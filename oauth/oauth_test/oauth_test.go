...
func TestOauthGetTokenWithWireMock(
	t *testing.T,
) {
	wiremockPort := os.Getenv("WIREMOCK_PORT")
	if wiremockPort == "" {
	...
	_, invocationErr := client.Oauth.GetToken(
		...
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestOauthGetTokenWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestOauthGetTokenWithWireMock", "POST", "/api/v1/oauth/token", nil, 1)
}
