...
func (r *RawClient) PublishEntity(
...
) (*core.Response[*latticesdkgo.Entity], error) {
	...
	return &core.Response[*latticesdkgo.Entity]{
...
func (r *RawClient) LongPollEntityEvents(
	...
	opts ...option.RequestOption,
) (*core.Response[*latticesdkgo.EntityEventResponse], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	return &core.Response[*latticesdkgo.EntityEventResponse]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
