...
func (c *Client) ListObjects(
	ctx context.Context,
	request *latticesdkgo.ListObjectsRequest,
	opts ...option.RequestOption,
) (*core.Page[*latticesdkgo.PathMetadata], error) {
	options := core.NewRequestOptions(opts...)
	...
	errorCodes := internal.ErrorCodes{
		...
		500: func(apiError *core.APIError) error {
			return &latticesdkgo.InternalServerError{
				APIError: apiError,
			}
		},
	}
	...
	readPageResponse := func(response *latticesdkgo.ListResponse) *internal.PageResponse[*string, *latticesdkgo.PathMetadata] {
		var zeroValue *string
		next := response.NextPageToken
		results := response.PathMetadatas
		return &internal.PageResponse[*string, *latticesdkgo.PathMetadata]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
...
func (c *Client) GetObject(
	...
	objectPath string,
	request *latticesdkgo.GetObjectRequest,
	opts ...option.RequestOption,
) (io.Reader, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
...
func (c *Client) UploadObject(
	...
	request io.Reader,
	opts ...option.RequestOption,
) (*latticesdkgo.PathMetadata, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	errorCodes := internal.ErrorCodes{
		...
		413: func(apiError *core.APIError) error {
			return &latticesdkgo.ContentTooLargeError{
				APIError: apiError,
			}
		},
		500: func(apiError *core.APIError) error {
		...
		507: func(apiError *core.APIError) error {
			return &latticesdkgo.InsufficientStorageError{
				APIError: apiError,
			}
		},
	}

	var response *latticesdkgo.PathMetadata
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
