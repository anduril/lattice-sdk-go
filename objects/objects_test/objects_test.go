...
func TestObjectsListObjectsWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/api/v1/objects")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"path_metadatas": []interface{}{map[string]interface{}{"content_identifier": map[string]interface{}{"path": "path", "checksum": "checksum"}, "size_bytes": 1000000, "last_updated_at": "2024-01-15T09:30:00Z", "expiry_time": "2024-01-15T09:30:00Z"}}, "next_page_token": "next_page_token"},
...
func TestObjectsGetObjectWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/api/v1/objects/{objectPath}")).WithPathParam(
		"objectPath",
		gowiremock.Matching("objectPath"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
...
func TestObjectsDeleteObjectWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/api/v1/objects/{objectPath}")).WithPathParam(
		"objectPath",
		gowiremock.Matching("objectPath"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
...
func TestObjectsGetObjectMetadataWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Head(gowiremock.URLPathTemplate("/api/v1/objects/{objectPath}")).WithPathParam(
		"objectPath",
		gowiremock.Matching("objectPath"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
